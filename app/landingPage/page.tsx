                ...
                <div className="flex flex-col items-start justify-center h-full px-6 pb-8 md:px-16 md:pb-24 w-full md:w-1/2">
                  ...
                  <div className="flex space-x-8 pt-4">
                    {profileData.socialMedia.map((social, index) => (
                      ...
                      >
                          {social.platform === 'LinkedIn' && <FaLinkedin className="text-black" />}  
                          {social.platform === 'GitHub' && <FaGithub className="text-black" />}      
                          {social.platform === 'Twitter' && <FaTwitter className="text-black" />}    
                      </a>
                    ))}
                  </div>
                </div>
